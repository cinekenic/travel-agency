...
describe('Component Hero', () => {
  it('should render without crashing', () => {
    const component = shallow(<Hero titleText='Lorem ipsum' imageSrc='blbla.jpg' />);
...
it('should render correct title and image', () => {
  ...
  it('renders correct className', ()=>{
      const mockVariant = 'small dummy';
      const component = shallow(<Hero titleText='Lorem' imageSrc='image.jpg' variant= {mockVariant} />)
