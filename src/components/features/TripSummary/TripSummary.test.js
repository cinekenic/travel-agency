...
describe('Component TripSummary', ()=>{
    it('should render without crashing', ()=>{
        const component = shallow(<TripSummary id='aaa' image='iii.jpg' name='nnn' cost='$100' days={5} tags={['aaa', 'bbb', 'ccc']} />)
    });
    ...
    it('should render correct link with id',()=>{
        ...
        const component = shallow(<TripSummary variant={mockVariant} id={expectedId} tags={[]}/>)
